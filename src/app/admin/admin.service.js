...
var AdminService = (function () {
    ...
    AdminService.prototype.getForm = function (url, form) {
    ...
    AdminService.prototype.saveForm = function (url, model) {
    ...
    AdminService.prototype.updateForm = function (url, model, updateid) {
        var body = JSON.stringify(model);
        var headers = new http_1.Headers({ 'Content-Type': 'application/json' });
        var options = new http_1.RequestOptions({ headers: headers });
    ...
    AdminService.prototype.saveQueryData = function (url, model) {
