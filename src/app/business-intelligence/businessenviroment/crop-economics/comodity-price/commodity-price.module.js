...
var commodity_price_routing_1 = require('./commodity-price.routing');
var commodity_price_component_1 = require('./commodity-price.component');
var CommodityPriceModule = (function () {
    function CommodityPriceModule() {
    }
    CommodityPriceModule = __decorate([
        core_1.NgModule({
            imports: [
                http_1.HttpModule,
                forms_1.FormsModule,
                ...
                commodity_price_routing_1.CommodityPriceRouting,
                loader_module_1.LoaderModule
            ],
            declarations: [
                commodity_price_component_1.CommodityPriceComponent
            ],
            exports: [
                commodity_price_component_1.CommodityPriceComponent
            ]
    ...
    return CommodityPriceModule;
}());
exports.CommodityPriceModule = CommodityPriceModule;
//# sourceMappingURL=commodity-price.module.js.map