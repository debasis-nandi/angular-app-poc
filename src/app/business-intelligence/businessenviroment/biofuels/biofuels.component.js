...
var BiofuelsComponent = (function () {
    function BiofuelsComponent(chartService, ref, _ExcelExportService, dataListService) {
        ...
        this.insightFilterValues = { insightId: null, insightData: '', pageName: global_config_1.Page.biofuels.toString(), appliedFilterId: null, widgetDetailIds: '', appliedFilters: [], identificationFlag: '', author: '', updatedBy: '', updatedDate: null, isActive: true };
        this.pageName = global_config_1.Page.biofuels.toString();
        this.filterObject = [];
        this.exportObject = [];
        this.filterApi = [];
        this.exportApi = [];
        ...
        this.seriveParams = { pageName: global_config_1.Page.biofuels, companyId: 0, cropId: 0, selectedFilter: null, userId: global_util_1.GlobalUtil.getAppSession("UserInfo").userId, regionName: global_util_1.GlobalUtil.getAppSession("UserInfo").region };
    ...
    BiofuelsComponent.prototype.getPageModuleId = function () {
        return global_util_1.GlobalUtil.getSession("PageModuleId");
    };
    BiofuelsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    BiofuelsComponent.prototype.onFilterEmit = function (filter) {
    ...
    BiofuelsComponent.prototype.initChartInsightEditor = function (widgetId, index) {
    ...
    BiofuelsComponent.prototype.collapseChartInsight = function () {
    ...
    BiofuelsComponent.prototype.collapsePageInsight = function () {
        var s = document.getElementById('insightTargetTitle');
        if (s != null) {
            s.click();
        }
    };
    BiofuelsComponent.prototype.initInsight = function () {
        this.iInsights = {
            insightId: null,
            insightData: this.insightsData,
            pageName: global_config_1.Page.biofuels.toString(),
    ...
    BiofuelsComponent.prototype.setAppliedFilters = function (appliedFilters) {
    ...
    BiofuelsComponent.prototype.getFilters = function (filterObject) {
        this.getWidgetIds();
        this.appliedFilters = [];
    ...
    BiofuelsComponent.prototype.setChartInsights = function () {
        this.chartInsights = [];
    ...
    BiofuelsComponent.prototype.getWidgetIds = function () {
        var chartsDetails = this.data.exports.filter(function (model) { return model.exportName == "Chart Names"; });
        if (chartsDetails.length > 0) {
            var widgets = chartsDetails[0].exportData;
            if (widgets.length > 0) {
    ...
    BiofuelsComponent.prototype.InsightListCount = function (event) {
    ...
    BiofuelsComponent.prototype.setInsightValues = function () {
    ...
    //-- insight methods
    BiofuelsComponent.prototype.FilterSubmit = function (pagePopover) {
        var _this = this;
        this.loading = true;
    ...
    BiofuelsComponent.prototype.GetSelectedFilters = function (filterObject) {
        this.selectedFilters = [];
        if (filterObject != null) {
            ...
            var _loop_3 = function(entry) {
                ...
                if (entry.filterName == 'Region' || entry.filterName == 'Country' || entry.filterName == 'Unit Type') {
    ...
    BiofuelsComponent.prototype.DefaultSelectedFilters = function (filterObject) {
        this.selectedFilters = [];
        if (filterObject != null) {
    ...
    BiofuelsComponent.prototype.ExportSubmit = function () {
        var _this = this;
        this.loading = true;
        var index;
    ...
    BiofuelsComponent.prototype.onExportVisibleEmit = function (visible) {
        this.exportVisible = visible;
    };
    __decorate([
        core_1.ViewChild('pagePopover'), 
        __metadata('design:type', ng2_popover_1.PopoverContent)
    ], BiofuelsComponent.prototype, "pagePopover", void 0);
    BiofuelsComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
            templateUrl: 'biofuels.component.html'
        }), 
    ...
    return BiofuelsComponent;
}());
exports.BiofuelsComponent = BiofuelsComponent;
//# sourceMappingURL=biofuels.component.js.map