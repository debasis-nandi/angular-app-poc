...
export class BiofuelsComponent {
    //**Insight variables
    ...
    insightFilterValues: IInsights = { insightId: null, insightData: '', pageName: Page.biofuels.toString(), appliedFilterId: null, widgetDetailIds: '', appliedFilters: [], identificationFlag: '', author: '', updatedBy: '', updatedDate: null, isActive: true };
     //--Insight variables
    data: IPageDataMapper;
    pageName: string = Page.biofuels.toString();
    errorMessage: string;
   ...
   // insightDetails: IInisghts = {};
    seriveParams: IServiceParams = { pageName: Page.biofuels, companyId: 0, cropId: 0, selectedFilter: null, userId: GlobalUtil.getAppSession("UserInfo").userId, regionName: GlobalUtil.getAppSession("UserInfo").region };
   ...
   // noInsightDate = Constants.noInsightDate;
    ...
    initInsight() {
        this.iInsights = {
            ...
            pageName: Page.biofuels.toString(),
