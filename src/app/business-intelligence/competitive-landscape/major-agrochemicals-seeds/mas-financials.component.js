...
var MASFinancialsComponent = (function () {
    function MASFinancialsComponent(chartService, ref, _ExcelExportService, dataListService, router) {
        ...
        this.insightFilterValues = { insightId: null, insightData: '', pageName: global_config_1.Page.ciFinancials.toString(), appliedFilterId: null, widgetDetailIds: '', appliedFilters: [], identificationFlag: '', author: '', updatedBy: '', updatedDate: null, isActive: true };
        this.filterObject = [];
        this.exportObject = [];
        this.filterApi = [];
        this.exportApi = [];
        ...
        this.submitMessage = '';
        this.pageName = global_config_1.Page.ciFinancials.toString();
        this.selectedFilters = [];
        this.seriveParams = { pageName: global_config_1.Page.ciFinancials, companyId: global_util_1.GlobalUtil.getSession("CompetitorId"), cropId: 0, selectedFilter: null, userId: global_util_1.GlobalUtil.getAppSession("UserInfo").userId, regionName: global_util_1.GlobalUtil.getAppSession("UserInfo").region };
        this.kpi = [];
    }
    MASFinancialsComponent.prototype.ngOnInit = function () {
        var _this = this;
        if (global_util_1.GlobalUtil.getSession("CompetitorId")) {
            ...
            if (global_util_1.GlobalUtil.getSession("ChartYear") != "" && global_util_1.GlobalUtil.getSession("ChartYear") != null) {
                ...
                var selectedPara = { pageName: global_config_1.Page.ciFinancials.toString(), companyId: global_util_1.GlobalUtil.getSession("CompetitorId"), cropId: 0, selectedFilter: filterPara, isSearchRedirct: true };
    ...
    MASFinancialsComponent.prototype.onFilterEmit = function (filter) {
    ...
    MASFinancialsComponent.prototype.onSubmitEmit = function (visible) {
        this.submitVisible = visible;
    };
    MASFinancialsComponent.prototype.onSubmitMessageEmit = function (message) {
        this.submitMessage = message;
    };
    MASFinancialsComponent.prototype.OnInsightEditorFocus = function (editorId) {
    ...
    MASFinancialsComponent.prototype.setInsightValues = function () {
    ...
    MASFinancialsComponent.prototype.initPageInsightEditor = function () {
    ...
    MASFinancialsComponent.prototype.initChartInsightEditor = function (widgetId, index) {
    ...
    MASFinancialsComponent.prototype.collapseChartInsight = function () {
    ...
    MASFinancialsComponent.prototype.collapsePageInsight = function () {
        var s = document.getElementById('insightTargetTitle');
        if (s != null) {
            s.click();
        }
    };
    MASFinancialsComponent.prototype.initInsight = function () {
        this.iInsights = {
            insightId: null,
            insightData: this.insightsData,
            pageName: global_config_1.Page.ciFinancials,
    ...
    MASFinancialsComponent.prototype.setAppliedFilters = function (appliedFilters, filterObject) {
    ...
    MASFinancialsComponent.prototype.getFilters = function (filterObject) {
        this.getWidgetIds();
        this.appliedFilters = [];
    ...
    MASFinancialsComponent.prototype.setChartInsights = function () {
        this.chartInsights = [];
    ...
    MASFinancialsComponent.prototype.getWidgetIds = function () {
        var chartsDetails = this.data.exports.filter(function (model) { return model.exportName == "Chart Names"; });
        if (chartsDetails.length > 0) {
            var widgets = chartsDetails[0].exportData;
            if (widgets.length > 0) {
    ...
    MASFinancialsComponent.prototype.FilterSubmit = function (pagePopover) {
        var _this = this;
        this.loading = true;
        var insightFilterValues = { insightId: null, insightData: '', pageName: global_config_1.Page.ciFinancials, appliedFilterId: null, widgetDetailIds: '', appliedFilters: [], identificationFlag: '', author: '', updatedBy: '', updatedDate: null, isActive: true };
        ...
        this.dataListService.getInsights(insightFilterValues).subscribe(function (data) {
            _this.insightViewModel = data;
            var selectedValue = { pageName: global_config_1.Page.ciFinancials.toString(), companyId: global_util_1.GlobalUtil.getSession("CompetitorId"), cropId: 0, selectedFilter: _this.filterApi, userId: global_util_1.GlobalUtil.getAppSession("UserInfo").userId };
    ...
    MASFinancialsComponent.prototype.GetSelectedFilters = function (filterObject) {
        this.selectedFilters = [];
    ...
    MASFinancialsComponent.prototype.ExportSubmit = function () {
        var _this = this;
        this.loading = true;
        var index;
    ...
    MASFinancialsComponent.prototype.onExportVisibleEmit = function (visible) {
        this.exportVisible = visible;
    };
    MASFinancialsComponent.prototype.onExportEmit = function (exp) {
        this.exportObject = this.exportObject.filter(function (x) { return x.exportName !== exp.exportName; });
        this.exportObject.push(exp);
        return true;
    };
    MASFinancialsComponent.prototype.getPageModuleId = function () {
        return global_util_1.GlobalUtil.getSession("PageModuleId");
    };
    MASFinancialsComponent.prototype.InsightListCount = function (event) {
    ...
    ], MASFinancialsComponent.prototype, "pagePopover", void 0);
    MASFinancialsComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
            selector: 'my-app',
    ...
    return MASFinancialsComponent;
}());
exports.MASFinancialsComponent = MASFinancialsComponent;
//# sourceMappingURL=mas-financials.component.js.map