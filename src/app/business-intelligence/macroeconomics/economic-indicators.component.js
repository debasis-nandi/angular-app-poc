...
var EconomicIndicatorsComponent = (function () {
    function EconomicIndicatorsComponent(chartService, ref, _ExcelExportService, dataListService) {
        ...
        this.insightFilterValues = { insightId: null, insightData: '', pageName: global_config_1.Page.macroeconomicsIndicators.toString(), appliedFilterId: null, widgetDetailIds: '', appliedFilters: [], identificationFlag: '', author: '', updatedBy: '', updatedDate: null, isActive: true };
        this.pageName = global_config_1.Page.MacroEconomicsIndicator.toString();
        this.filterObject = [];
        this.exportObject = [];
        this.filterApi = [];
        this.exportApi = [];
        ...
        this.seriveParams = { pageName: global_config_1.Page.macroeconomicsIndicators, companyId: 0, cropId: 0, selectedFilter: null, userId: global_util_1.GlobalUtil.getAppSession("UserInfo").userId, regionName: global_util_1.GlobalUtil.getAppSession("UserInfo").region };
        this.kpi = [];
    }
    EconomicIndicatorsComponent.prototype.getPageModuleId = function () {
        return global_util_1.GlobalUtil.getSession("PageModuleId");
    };
    EconomicIndicatorsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loading = true;
    ...
    EconomicIndicatorsComponent.prototype.initChartInsightEditor = function (widgetId, index) {
    ...
    EconomicIndicatorsComponent.prototype.collapseChartInsight = function () {
    ...
    EconomicIndicatorsComponent.prototype.collapsePageInsight = function () {
        var s = document.getElementById('insightTargetTitle');
        if (s != null) {
            s.click();
        }
    };
    EconomicIndicatorsComponent.prototype.initInsight = function () {
        this.iInsights = {
            insightId: null,
            insightData: this.insightsData,
            pageName: global_config_1.Page.macroeconomicsIndicators.toString(),
    ...
    EconomicIndicatorsComponent.prototype.setAppliedFilters = function (appliedFilters) {
    ...
    EconomicIndicatorsComponent.prototype.getFilters = function (filterObject) {
        this.getWidgetIds();
        this.appliedFilters = [];
    ...
    EconomicIndicatorsComponent.prototype.setChartInsights = function () {
        this.chartInsights = [];
    ...
    EconomicIndicatorsComponent.prototype.getWidgetIds = function () {
        var chartsDetails = this.data.exports.filter(function (model) { return model.exportName == "Chart Names"; });
        if (chartsDetails.length > 0) {
            var widgets = chartsDetails[0].exportData;
            if (widgets.length > 0) {
    ...
    EconomicIndicatorsComponent.prototype.InsightListCount = function (event) {
    ...
    EconomicIndicatorsComponent.prototype.setInsightValues = function () {
    ...
    //-- insight methods
    EconomicIndicatorsComponent.prototype.FilterSubmit = function (pagePopover) {
        var _this = this;
        this.loading = true;
    ...
    EconomicIndicatorsComponent.prototype.GetSelectedFilters = function (filterObject) {
        this.selectedFilters = [];
    ...
    EconomicIndicatorsComponent.prototype.DefaultSelectedFilters = function (filterObject) {
        this.selectedFilters = [];
        if (filterObject != null) {
            ...
            var _loop_5 = function(entry) {
                ...
                this_5.insightFilterValues.appliedFilters.push(insightAppliedFilterObj);
    ...
    EconomicIndicatorsComponent.prototype.ExportSubmit = function () {
        var _this = this;
        this.loading = true;
        var index;
                    ...
                    if (Insights.length > 0) {
                        for (var _b = 0, Insights_1 = Insights; _b < Insights_1.length; _b++) {
                            ...
                            if (insightitem.insightData != null || insightitem.insightData != undefined) {
                                //PageInsightData = PageInsightData.concat(insightitem.insightData).concat('\n');
    ...
    EconomicIndicatorsComponent.prototype.onExportVisibleEmit = function (visible) {
        this.exportVisible = visible;
    };
    __decorate([
        core_1.ViewChild('pagePopover'), 
        __metadata('design:type', ng2_popover_1.PopoverContent)
    ], EconomicIndicatorsComponent.prototype, "pagePopover", void 0);
    EconomicIndicatorsComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return EconomicIndicatorsComponent;
}());
exports.EconomicIndicatorsComponent = EconomicIndicatorsComponent;
//# sourceMappingURL=economic-indicators.component.js.map