...
export class EconomicIndicatorsComponent {
    ...
    insightFilterValues: IInsights = { insightId: null, insightData: '', pageName: Page.macroeconomicsIndicators.toString(), appliedFilterId: null, widgetDetailIds: '', appliedFilters: [], identificationFlag: '', author: '', updatedBy: '', updatedDate: null, isActive: true };
     //--Insight variables
    data: IPageDataMapper;
    pageName: string = Page.MacroEconomicsIndicator.toString();
    errorMessage: string;
   ...
   // noInsightDate = Constants.noInsightDate;
    ...
    seriveParams: IServiceParams = { pageName: Page.macroeconomicsIndicators, companyId: 0, cropId: 0, selectedFilter: null, userId: GlobalUtil.getAppSession("UserInfo").userId, regionName: GlobalUtil.getAppSession("UserInfo").region };
    ...
    initInsight() {
        this.iInsights = {
            ...
            pageName: Page.macroeconomicsIndicators.toString(),
    ...
    DefaultSelectedFilters(filterObject: IFilters[]): void {
        ...
        if (filterObject != null) {
            ...
            for (let entry of filterObject) {
                ...
                this.insightFilterValues.appliedFilters.push(insightAppliedFilterObj);
                this.selectedFilters.push(this.selectedData);
            }
        }
    }
